# Motion contract — C-PLANS-LIFECYCLE-DESKTOP-252-V6
...
With `prefers-reduced-motion: reduce`, the behavior is identical: selection, focus, empty text and narrow-width fallback switch immediately. No operation depends on an animation event or duration.
