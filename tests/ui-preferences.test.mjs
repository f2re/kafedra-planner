...
test('существующая schema 17 обновляется через 019 до текущей схемы без изменения предметных данных', async () => {
  ...
  try {
    ...
    assert.equal(upgraded.get('SELECT MAX(version) AS v FROM schema_migrations').v, 24);
