...
const STABLE_TABLES = [
  ...
  'academic_grade_import_disciplines', 'academic_grade_import_students',
  'academic_grade_records', 'academic_grade_import_issues',
  ...
  'plans', 'plan_items', 'plan_item_assignments', 'plan_source_rows', 'plan_source_row_items',
