...
Download the four required files from the selected [GitHub Release](https://github.com/f2re/kafedra-planner/releases), keep them in one directory, verify the checksum, and run:
...
For another architecture or OS series, build a bundle on a compatible
Debian/Astra reference machine instead:
